<template>
    <div class="mitre-enterprise-page">
        <h1 class="page-title">Mitre Enterprise</h1>

        <v-client-table :columns="columns" v-model="mitreEnterprise" :options="options">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState('data', ['mitreEnterprise'])
        }
    };
</script>

<style src="./MitreEnterprise.scss" lang="scss" />
